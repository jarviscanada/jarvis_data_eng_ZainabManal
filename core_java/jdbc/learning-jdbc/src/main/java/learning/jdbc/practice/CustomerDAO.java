package learning.jdbc.practice;

import learning.jdbc.practice.util.DataAccessObject;
...
public class CustomerDAO extends DataAccessObject<Customer> {
  ...
  private final String GET_ONE = "SELECT customer_id, first_name, last_name, email, phone,"
